...
function FoodCollection() {
  ...
  const fetchFoodCollection = async () => {
    try {
      ...
      const apiData = `https://corsproxy.io/https://www.swiggy.com/dapi/restaurants/list/v5?lat=19.0644917&lng=72.8637579&collection=${params.collection_id}&tags=${params.tags}&type=${params.type}`;
