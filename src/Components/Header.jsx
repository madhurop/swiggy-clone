...
export default function NavBar() {
  ...
  return (
    <div>
      <header className="">
        <nav className="flex flex-row justify-between bg-white border border-solid border-gray-200 shadow-2xl">
          <div className="">
          ...
          <ul className=" flex flex-row justify-evenly gap-2 w-2/5 items-center">
            ...
            <li><Link className='hover:text-red-500' to="/instamart">InstaMart</Link></li>
            <li><Link className='hover:text-red-500' to="/search">Search</Link></li>
            <li><Link className='hover:text-red-500' to="/offer">Offer</Link></li>
            <li><Link className='hover:text-red-500' to="/help">Help</Link></li>
            <li><Link className='hover:text-red-500' to="#">Sign In</Link></li>
            <li><Link className='hover:text-red-500' to="#">Cart</Link></li>
          </ul>
        </nav>
      </header>
